<?php
	include 'lib_db.php';
	// $topSql = "SELECT * FROM news order by id desc limit 3 ";
...
<body>
    ...
    <div class="container main-content ">
        <div class="row">
            <div class="event-grip">
                
                <?php
                foreach($data as $item){
                    echo '<div class="event-item item-event">
                    <div class="event-avatar">
                        <div class="category-news-image">
                            <a href="detail_event.php?id='.$item["id"].'">
                                <img src="'.$item['image'].'"
                             class="img-flex"></a>
                    </div>
                </div>
                ...
                <div class="event-body">
                    <h2><a class="fw-600"
                           href="detail_event.php?id='.$item["id"].'"style="line-height: 1.4">'.$item['name'].'</a></h2>
                            <p>
                                <i class="fa fa-clock mr-2"></i>';
                    echo date('H:i:s - d/m/Y',strtotime($item["date"]));  
                    echo '</p>
                    <p class="mb-0 d-none d-md-block"><strong class="fw-600">Đơn vị tổ chức: </strong>'.$item["host"].'</p>
                    <p class="mb-0 d-none d-md-block"><strong class="fw-600">Địa điểm: </strong>'.$item["address"].'</p>
                    </div>
                </div>';              
                } ?>
            </div>
