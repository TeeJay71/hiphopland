<?php
	include 'lib_db.php';
	$topSql = "SELECT * FROM news where cid =2 order by id desc limit 3 ";
    $sql="SELECT * FROM news where cid =2 order by id desc";
                ...
                <div class="row hot-new flex">
                    <div class="col-7-dm card-hn">
                        ...
                        <div class="detail-hn-t1">
                            ...
                            <div class="flex-box">
                                <p> <i
                                        class="fas fa-folder"></i> Kiến thứcq</p>
                                <p><i
                    ...
                    <div class="col-3-dm card-hn">
                        <div class="card-hn-m">
                            ...
                            <div class="detail-hn-t1">
                                ...
                                <div class="flex-box">
                                    <p><i
                                        class="fas fa-folder"></i> Kiến thức</p>
                                    <p><i
