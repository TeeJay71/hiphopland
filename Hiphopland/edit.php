            ...
            <form class="form" action="edit_exec.php" method="post" enctype="multipart/form-data">
                ...
                <select name="cid">
                    ...
                    <option value="<?php echo $item["id"]?>"
                        <?php if ($item["id"] == $result["cid"]){?>selected<?php } ?>><?php echo $item["name"]?>
                    </option>
                    <?php } ?>
                </select>
                ...
                <div class="clear-both"></div>
                <label>Title</label><input name="title" value="<?php echo $result["title"]?>" />
                <div class="clear-both"></div>
                <label>Content</label><input name="content" value="<?php echo $result["content"]?>" />
